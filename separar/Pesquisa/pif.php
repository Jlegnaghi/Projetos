...
<head>
    ...
    <title>PIF (Ponte Internacional da Fraternidade)</title>
</head>
<body>
    <h1>
        <img src="img/argentina.png" alt="Imagem H1" width="127" height="79">
        Pesquisa PIF
    </h1>
    <h2>(Ponte Internacional da Fraternidade)</h2>

    <form action="processar_catraca_saida_pif.php" method="post">
    ...
    <form action="processar_catraca_entrada_pif.php" method="post">
    ...
    <div class="popup" id="popup">
        <div class="popup-content">
            ...
            <a href="exporta_pif.php" download>
